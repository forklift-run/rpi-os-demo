...
# Install cockpit
# Note(ethanjli): we need to adjust update-initramfs's behavior to make apt-get finish successfully;
# see https://github.com/PlanktoScope/PlanktoScope/pull/596 and
